...
import imutils
import dlib
from tracker_classes.centroidtracker import CentroidTracker
from tracker_classes.trackableobject import TrackableObject
...
# otherwise, grab the reference of the input file
else:
